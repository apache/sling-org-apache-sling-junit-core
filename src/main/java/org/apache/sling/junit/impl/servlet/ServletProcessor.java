...
public class ServletProcessor {
    ...
    public ServletProcessor(final TestsManager testsManager, final RendererSelector rendererSelector) {
    ...
    public void doGet(final HttpServletRequest request, final HttpServletResponse response, final String servletPath)
        ...
        if (testNames.isEmpty()) {
            final String msg = "WARNING: no test classes found for selector " + selector
                    + ", check the requirements of the active " + "TestsProvider services for how to supply tests.";
