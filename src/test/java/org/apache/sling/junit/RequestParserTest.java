...
public class RequestParserTest {
    ...
    void testSelector(
            String pathInfo, String expectedTestSelector, String expectedExtension, String expectedMethodSelector) {
    ...
    static Stream<Arguments> acceptTestNameArguments() {
        return concatStreams(
                toArguments(
                        "/org.example.FooTest/testBar.html",
                        array("org.example.FooTest"),
                        array("org.example.FooTest$1")),
                toArguments(
                        "/org.example.FooTest.html",
                        array("org.example.FooTest"),
    ...
    static Stream<Arguments> configs() {
        return Stream.of(
                ...
                arguments(
                        "someTests.here.html.json/TEST_METHOD_NAME.txt",
                        "someTests.here.html.json",
                        "txt",
                        "TEST_METHOD_NAME"),
